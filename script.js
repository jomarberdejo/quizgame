...
function startButton() {
  ...
  if (userName == null || userName== ""){
    ...
    alert("Welcome " + userName+", Good Luck For The Quiz!");
    ...
    if (confirm("Are you sure you are ready to take on this question? ")== true) {
        ...
        if (answer1 == null || answer1== ""){
         alert("You didn't answer the question!")
            ...
            alert("Oops, Your Answer Is Wrong Try Again Later.")
...
function logOut() {
  if (confirm("All Your Progress Will Be Reset, Continue?")== true){
  userName = null;
  score = 0;
  ...
  document.getElementById('question-type').style.display = "none";
  ...
  document.getElementById("paragraphs").display= "none";
  document.getElementById("q1-check").style.display= "none";
  document.getElementById("q2-check").style.display= "none";
  document.getElementById("q3-check").style.display= "none";
